...
function handleOnClick (e) {
  ...
  return (
      ...
      <button id="truck" onClick={(e) => handleOnClick(e)}>Trucks</button>
      {(truckDropDown === true)? truckMenu() : <div /> }
      <button id="jeep" onClick={(e) => handleOnClick(e)}>Jeeps</button>
      {(jeepDropDown === true)? jeepMenu() : <div /> }
      <button id="car" onClick={(e) => handleOnClick(e)}>Cars</button>
      {(carDropDown === true)? carMenu() : <div /> }
      <button id="suv" onClick={(e) => handleOnClick(e)}>Suv</button>
      {(suvDropDown === true)? suvMenu() : <div /> }
      <button id="van" onClick={(e) => handleOnClick(e)}>Van</button>
      {(vanDropDown === true)? vanMenu() : <div /> }
      <button id="scar" onClick={(e) => handleOnClick(e)}>Sport cars</button>
